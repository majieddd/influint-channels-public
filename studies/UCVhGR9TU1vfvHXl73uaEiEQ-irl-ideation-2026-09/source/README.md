...
The five solo formats and 25 episode briefs are authored in `../solo-formats.json`. `solo_sections.py` renders their Ideation, Creative, Production and Data Analysis additions. Solo IDs 101-125 use their own expandable briefs; original gallery IDs 1-100 keep the existing pagination and thumbnail mappings.
